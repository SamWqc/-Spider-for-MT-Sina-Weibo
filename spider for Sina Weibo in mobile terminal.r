#######################the work in advance################
#First guarantee there is the Java in ur PC and make sure the configuration is Ok
#Then download 'Selenium' 
#Choose the browser (Chrome or FireFox) and download the browser driver 
#put browser driver in the same directory as the browser
#start selenium in system cmd (java -jar selenium-server-standalone-3.8.1.jar)
